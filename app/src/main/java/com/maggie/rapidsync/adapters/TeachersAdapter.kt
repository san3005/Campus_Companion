...
class TeachersAdapter(
    private val options: List<User>,
    private val onOptionSelected: (User) -> Unit
) :
    RecyclerView.Adapter<TeachersAdapter.OptionViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OptionViewHolder, position: Int) {
        ...
        holder.location.text = currentOption.username
        holder.speciality.text = currentOption.email
        holder.book.text = "Schedule appointment"
